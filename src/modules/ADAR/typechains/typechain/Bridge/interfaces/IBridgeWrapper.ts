...
export interface IBridgeWrapperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAdmin"
      | "getBalance"
...
export interface IBridgeWrapper extends BaseContract {
  connect(runner?: ContractRunner | null): IBridgeWrapper;
  waitForDeployment(): Promise<this>;

  interface: IBridgeWrapperInterface;
