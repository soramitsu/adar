          ...
          <div v-for="(amountInfo, idx) in transferTxsAmountInfo" :key="idx" class="amount-info">
            ...
            <div class="amount-info__info">
              ...
              <info-line
                ...
                :value="amountInfo.totalAmount.toFixed(5).toLocaleString()"
              ...
              <info-line
                ...
                :value="amountInfo.userBalance.toFixed(5).toLocaleString()"
          ...
          <div class="amount-info">
            ...
            <div class="amount-info__info">
              ...
              <info-line
                ...
                :value="maxInputAmount.totalAmount.toFixed(5).toLocaleString()"
              ...
              <info-line
                ...
                :value="fpBalance.toFixed(5).toLocaleString()"
                is-formatted
              />
            </div>
          </div>
